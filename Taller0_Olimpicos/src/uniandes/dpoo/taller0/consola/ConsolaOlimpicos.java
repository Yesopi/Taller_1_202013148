...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		// Modificacion 1 opcion 13
		System.out.println("13. Consultar el Pais de un atleta deseado");
	...
	{
		String atletadeinteres = input("Por favor ingrese el nombre del atleta que desee");
		String resultado=calculadora.paisdelatleta(atletadeinteres);
		System.out.println("El atleta "+atletadeinteres+" representa al pais: "+resultado);
	}
	...
	private void ejecutarCargarAtletas()
	{
		...
		String archivo = input("Por favor ingrese el nombre del archivo CSV con los atletas (data/atletas.csv)");
		try
		{
